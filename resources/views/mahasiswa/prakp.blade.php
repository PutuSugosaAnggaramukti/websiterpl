...
<button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal">
         ...
         <table class="table">
          ...
          @foreach ($data_pkp as $prakp)
              <tr>
                  <td>{{$prakp->NIM}}</td>
                  <td>{{$prakp->lembaga}}</td>
                  <td>{{$prakp->alamat}}</td>
                  <td>{{$prakp->pimpinan}}</td>
                  <td>{{$prakp->tools}}</td>
                  <td>{{$prakp->no_telp}}</td>
                  <td>{{$prakp->fax}}</td>
                  <td>{{$prakp->spek}}</td>
                  <td>{{$prakp->tools}}</td>
                  <td>{{$prakp->dokumen}}</td>
                  <td><a href="/editpkp/{{$prakp->id}}" class="btn btn-warning btn-sm">update</a></td>
              </tr>
          @endforeach
...
<div class="modal-body">
    <form action="/prakp/tambahprakp" method="POST">
      {{csrf_field()}}
